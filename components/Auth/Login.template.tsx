      ...
      <div className="flex justify-around">
        <div className="pt-3 w-94">
          ...
          <div className="flex justify-around mb-6">
            <button className="bg-green-500 w-64 h-10 rounded-md font-semibold text-purple-100 text-lg hover:bg-green-600 md:hover:cursor-pointer focus:outline-none focus:ring-4 focus:ring-green-600 focus:ring-opacity-50 focus:ring-offset-2">
              Đăng Nhập
            </button>
          </div>
